     ...
     <div class="container">
          <div class="card-panel">
               <span class="white-text">
                    <h4 style="text-align:left"><span style="font-size:30px" class="material-icons">info</span> <span id="title">Defesa Siciliana</span></h4>
...
<div class="jogadores">
     ...
     <div class="container">
          ...
          <div class="row">
               <div class="col s4"><img src="imgs/Whites.png" style="height: 100px; width:250px;"></img></div>
               <div class="col s4"></div>
               <div class="col s4"><img src="imgs/Blacks.png" style="height: 100px; width:250px;"></img></div>
          </div>
          <div class="row">
               <div class="col s12">
